...
<script type="text/html" class="rwmb_math_operator_json" data-jsoptions="%s" data-formula="%s" data-operatorfield="%s"></script>',
    ...
    {
        wp_enqueue_script('math_js', 'https://cdnjs.cloudflare.com/ajax/libs/mathjs/6.6.4/math.min.js', ['jquery'], uniqid(), true );
        wp_enqueue_script('math_operator_js', RWMB_math_operator_Field::get_file_url().'/js/rwmb_operation.js', ['jquery','rwmb','math_js'], uniqid(), true );
